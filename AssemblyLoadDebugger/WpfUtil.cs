...
namespace AssemblyLoadDebugger
{
    public static class ThemeUtils
    {
        ...
        public static void ShouldBeThemed(this Window control)
        {
            ShouldBeThemed((FrameworkElement)control);
            control.SetResourceReference(Control.BackgroundProperty, SharedVsTheme.WindowBackgroundBrushKey);
        }
    }
}
